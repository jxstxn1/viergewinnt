        ...
        time.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (Gui.gewinner == 0) {
                    ...
                    //Vertikal
                    if (Gui.state[0] ==2 && Gui.state[7] ==2 && Gui.state[14] ==2 && Gui.state[21] ==2) {
                        Gui.gewinner =2;
                    }
                    ...
                    else if (Gui.state[18] ==2 && Gui.state[31] ==2 && Gui.state[32] ==2 && Gui.state[33] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[19] ==2 && Gui.state[32] ==2 && Gui.state[33] ==2 && Gui.state[34] ==2){
                        Gui.gewinner =2;
                    }
                    ...
                    //Diagonal
                    if (Gui.state[0] ==2 && Gui.state[8] ==2 && Gui.state[16] ==2 && Gui.state[24] ==2) {
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[1] ==2 && Gui.state[9] ==2 && Gui.state[17] ==2 && Gui.state[25] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[2] ==2 && Gui.state[10] ==2 && Gui.state[18] ==2 && Gui.state[26] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[3] ==2 && Gui.state[11] ==2 && Gui.state[19] ==2 && Gui.state[27] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[7] ==2 && Gui.state[15] ==2 && Gui.state[23] ==2 && Gui.state[31] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[8] ==2 && Gui.state[16] ==2 && Gui.state[24] ==2 && Gui.state[32] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[9] ==2 && Gui.state[17] ==2 && Gui.state[25] ==2 && Gui.state[33] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[10] ==2 && Gui.state[18] ==2 && Gui.state[26] ==2 && Gui.state[34] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[14] ==2 && Gui.state[22] ==2 && Gui.state[30] ==2 && Gui.state[38] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[15] ==2 && Gui.state[23] ==2 && Gui.state[31] ==2 && Gui.state[39] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[16] ==2 && Gui.state[24] ==2 && Gui.state[32] ==2 && Gui.state[40] ==2){
                        Gui.gewinner =2;
                    }
                    else if (Gui.state[17] ==2 && Gui.state[25] ==2 && Gui.state[33] ==2 && Gui.state[41] ==2){
                        Gui.gewinner =2;
                    }
